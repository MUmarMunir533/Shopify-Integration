...
const CartSidebarModal = () => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 z-50 overflow-y-auto no-scrollbar w-full h-screen bg-dark/70 ease-linear duration-300 ${
        isCartModalOpen ? "translate-x-0" : "translate-x-full"
      }`}
    >
      <div className="flex items-center justify-end">
        <div className="w-full max-w-[500px] shadow-md bg-white px-4 sm:px-7.5 lg:px-11 relative modal-content">
          <div className="sticky top-0 bg-white flex items-center justify-between pb-7 pt-4 sm:pt-7.5 lg:pt-11 border-b border-gray-300 mb-7.5">
            ...
            <button
              ...
              className="flex items-center justify-center ease-in duration-150 bg-meta text-dark hover:text-dark"
            >
              <svg
          ...
          <div className="border-t border-gray-300 bg-white pt-5 pb-4 sm:pb-7.5 lg:pb-11 mt-7.5 sticky bottom-0">
